...
(function ($) {
    ...
    var $window = $(window),
            _applyErrorStyle = function ($elem, conf) {
                ...
                $elem
                        ...
                        .removeClass('jsvm_valid');
                if ($parent.hasClass("jsvm_input-group"))
                    $parent = $parent.parent();

                $parent.addClass('jsvm_has-error').removeClass('jsvm_has-success'); //twitter bs
            ...
            _removeErrorStyle = function ($elem, conf) {
                $elem.each(function () {
                    ...
                    $(this)
                            ...
                            .css('border-color', '');
                    $parent
                            .removeClass('jsvm_has-error')
                            .removeClass('jsvm_has-success')
            ...
            _setInlineErrorMessage = function ($input, mess, conf, $messageContainer) {
                ...
                if (custom) {
                    ...
                    var $mess = $parent.find('.' + conf.errorMessageClass + '.jsvm_help-block');
                    if ($mess.length == 0) {
                        $mess = $('<span></span>').addClass('jsvm_help-block').addClass(conf.errorMessageClass);
    ...
    $.fn.validateOnBlur = function (language, settings) {
        this.find('input[data-validation],textarea[data-validation],select[data-validation]')
                .bind('blur.jsvm_validation', function () {
    ...
    $.fn.validateOnEvent = function (language, settings) {
        this.find('input[data-validation][data-validation-event],textarea[data-validation][data-validation-event],select[data-validation][data-validation-event]')
                .each(function () {
                    ...
                    if (etype) {
                        $el.bind(etype + ".jsvm_validation", function () {
    ...
    $.fn.showHelpOnFocus = function (attrName) {
        ...
        this.find('.jsvm_has-help-txt')
                .valAttr('has-keyup-event', false)
                .removeClass('jsvm_has-help-txt');
        ...
        this.find('textarea,input').each(function () {
            ...
            if (help) {
                $elem
                        .addClass('jsvm_has-help-txt')
                        .unbind('focus.jsvm_help')
                        .bind('focus.jsvm_help', function () {
                            var $help = $elem.parent().find('.' + className);
                            if ($help.length == 0) {
                                $help = $('<span />')
                                        .addClass(className)
                                        .addClass('jsvm_help')
                                        .addClass('jsvm_help-block') // twitter bs
                                        .text(help)
                                        .hide();
                        ...
                        .unbind('blur.jsvm_help')
                        .bind('blur.jsvm_help', function () {
                            $(this)
                                    .parent()
                                    .find('.' + className)
                                    .fadeOut('slow');
    ...
    $.fn.validateInputOnBlur = function (language, conf, attachKeyupEvent, eventType) {
        ...
        if ((this.valAttr('suggestion-nr') || this.valAttr('postpone') || this.hasClass('jsvm_hasDatepicker')) && !window.postponedValidation) {
        ...
        if (validation === true) {
            $elem
                    .addClass('jsvm_valid')
                    .parent()
                    .addClass('jsvm_has-success'); // twitter bs
            ...
            if (attachKeyupEvent) {
                $elem
                        .unbind('keyup.jsvm_validation')
                        .bind('keyup.jsvm_validation', function () {
    ...
    $.fn.isValid = function (language, conf, displayError) {
        ...
        if (displayError) {
            $form.find('.' + conf.errorMessageClass + '.jsvm_alert').remove();
            _removeErrorStyle($form.find('.' + conf.errorElementClass + ',.jsvm_valid'), conf);
        }
    ...
    $.fn.addSuggestions = function (settings) {
        ...
        this.find('input').each(function () {
            ...
            if (sugs.length > 0 && !$field.hasClass('jsvm_has-suggestions')) {
                $.formUtils.suggest($field, sugs, settings);
                $field.addClass('jsvm_has-suggestions');
            }
        });
        return this;
    };
    ...
    $.validate = function (conf) {
        ...
        $(conf.form).each(function (i, form) {
            ...
            $form.find('.jsvm_has-help-txt')
                    .unbind('focus.jsvm_validation')
                    .unbind('blur.jsvm_validation');
            $form
                    .removeClass('jsvm_has-validation-callback')
                    .unbind('submit.jsvm_validation')
                    .unbind('reset.jsvm_validation')
                    .find('input[data-validation],textarea[data-validation]')
                    .unbind('blur.jsvm_validation');

            // Validate when submitted
            $form.bind('submit.jsvm_validation', function () {
                var $form = $(this);

                if ($.formUtils.isLoadingModules) {
                    setTimeout(function () {
                        $form.trigger('submit.jsvm_validation');
                    }, 200);
                    return false;
                }
                ...
                if (valid && typeof conf.onSuccess == 'function') {
                    ...
                    .bind('reset.jsvm_validation', function () {
                        // remove messages
                        $(this).find('.' + conf.errorMessageClass + '.jsvm_alert').remove();
                        _removeErrorStyle($(this).find('.' + conf.errorElementClass + ',.jsvm_valid'), conf);
                    })
                    .addClass('jsvm_has-validation-callback');
        ...
        defaultConfig: function () {
            return {
                ...
                errorMessageTemplate: {
                    container: '<div class="{jsvm_errorMessageClass} alert alert-danger">{messages}</div>',
        ...
        suggest: function ($elem, suggestions, settings) {
            ...
            if (this._numSuggestionElements === 0) {
                ...
                $window.bind('resize', function () {
                    $('.jsvm_jquery-form-suggestions').each(function () {
                        var $container = $(this),
                                suggestID = $container.attr('data-suggest-container');
                        setSuggsetionPosition($container, $('.jsvm_suggestions-' + suggestID).eq(0));
                    });
                });
            }
            ...
            var onSelectSuggestion = function ($el) {
                ...
                $('.jsvm_jquery-form-suggestion-' + suggestionId).fadeOut('fast');
            };
            ...
            $elem
                    ...
                    .unbind('keyup.jsvm_suggest')
                    .bind('keyup.jsvm_suggest', function () {
                        var $input = $(this),
                                foundSuggestions = [],
                        ...
                        var hasTypedSuggestion = false,
                                ...
                                $suggestionContainer = $('.jsvm_jquery-form-suggestion-' + suggestionId);
                        ...
                        // Create suggestion container if not already exists
                            ...
                            $suggestionContainer
                                    ...
                                    .addClass('jsvm_jquery-form-suggestions')
                                    .addClass('jsvm_jquery-form-suggestion-' + suggestionId);
                        }
                        ...
                        if (foundSuggestions.length > 0 && val.length != foundSuggestions[0].length) {
                            ...
                            $.each(foundSuggestions, function (i, text) {
                                $('<div></div>')
                                        ...
                                        .addClass('jsvm_form-suggest-element')
                    ...
                    .unbind('keydown.jsvm_validation')
                    .bind('keydown.jsvm_validation', function (e) {
                        ...
                        if (code == 13 && $.formUtils._selectedSuggestion !== null) {
                            ...
                            if ($suggestions.length > 0 && $.inArray(code, [38, 40]) > -1) {
                                ...
                                $suggestions
                                        .removeClass('jsvm_active-suggestion')
                                        .css('background', 'none')
                                        .eq($.formUtils._selectedSuggestion)
                                        .addClass('jsvm_active-suggestion')
                    ...
                    .unbind('blur.jsvm_suggest')
                    .bind('blur.jsvm_suggest', function () {
