...
<div id="jsvehiclemanageradmin-wrapper">
    ...
    <div id="jsvehiclemanageradmin-data">
        ...
        <div class="jsvm_page-actions">
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="publish" data-for-wpnonce="<?php echo wp_create_nonce("publish-model"); ?>"  href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/publish-icon.png" /><?php echo __('Publish', 'js-vehicle-manager') ?></a>
            <a class="jsvm_js-bulk-link button jsvm_multioperation" message="<?php echo JSVEHICLEMANAGERmessages::getMSelectionEMessage(); ?>" data-for="unpublish" data-for-wpnonce="<?php echo wp_create_nonce("unpublish-model"); ?>"  href="#"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/unbuplish.png" /><?php echo __('Unpublished', 'js-vehicle-manager') ?></a>
                    ...
                    <tbody>
                        ...
                        for ($i = 0, $n = count(jsvehiclemanager::$_data[0]); $i < $n; $i++) {
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <?php if ($row->status == 1) { ?>
                                        <a href="<?php echo wp_nonce_url(admin_url('admin.php?page=jsvm_model&task=unpublish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid),'unpublish-model'); ?>">
                                    ...
                                    <?php } else { ?>
                                        <a href="<?php echo wp_nonce_url(admin_url('admin.php?page=jsvm_model&task=publish&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid),'publish-model'); ?>">
                                ...
                                <td>
                                    <?php if ($i != 0 || $pagenum > 1) { ?>
                                        <a href="<?php echo wp_nonce_url(admin_url('admin.php?page=jsvm_common&task=defaultorderingup&action=jsvmtask&for=model&id='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid.'&jsvmlt=models'),'field-up'); ?>">
                                    ...
                                    <?php if ($i < $n - 1 || $islastordershow) { ?>
                                        <a href="<?php echo wp_nonce_url(admin_url('admin.php?page=jsvm_common&task=defaultorderingdown&action=jsvmtask&for=model&id='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid'].$pageid.'&jsvmlt=models'),'field-down'); ?>">
                                ...
                                <td class="jsvm_action">
                                    ...
                                    <a href="<?php echo wp_nonce_url(admin_url('admin.php?page=jsvm_model&task=remove&action=jsvmtask&jsvehiclemanager-cb[]='.$row->id.'&makeid='.jsvehiclemanager::$_data['makeid']),'delete-model'); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-vehicle-manager').' ?'; ?>');"><img src="<?php echo jsvehiclemanager::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-vehicle-manager'); ?>"></a>
                                </td>
                            </tr>
                    <?php
                        }
